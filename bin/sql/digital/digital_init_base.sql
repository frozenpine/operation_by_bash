...
insert  into `t_warn_insurance_fund`(`id`,`risk_flag`,`time_value`,`peek_value`,`warn_level`,`warn_type`,`interval_time`,`accounts`,`operator_id`,`operate_time`,`notice_status`,`old_id`) values (4,'261024',NULL,NULL,'1','2',5,'sub@quantdo.com.cn','admin',1545896347124,'0',NULL),(5,'261025','2','10.0000000000','1','2',5,'sub@quantdo.com.cn','admin',1545896347124,'0',NULL),(6,'261026',NULL,'10.0000000000','1','2',5,'sub@quantdo.com.cn','admin',1545896347124,'0',NULL),(7,'261027',NULL,'500000000','1','2',5,'sub@quantdo.com.cn','admin',1545896347124,'0',NULL);
...
insert  into `t_risk_limit`(`id`,`product_id`,`instrument_id`,`level`,`base_risk_limit`,`step_risk_limit`,`step_times`,`base_maint_margin`,`base_init_margin`,`operator_id`,`operate_time`,`old_id`,`notice_status`) values (11,'XBT',NULL,NULL,'20000000000','10000000000',9,'0.0050','0.0100','admin',1555980569597,NULL,'0');
